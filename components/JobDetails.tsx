...
import { ArrowLeft, HelpCircle, Link as LinkIcon, Package } from "lucide-react";
          ...
          <div>
            ...
            <div className="bg-gray-50 p-3 rounded-lg">
              <p className="text-sm font-medium">
                Receiver Name: {job.receiverName}
              </p>
              <p className="text-sm mt-1">Address: {job.address}</p>
              <p className="text-sm mt-1">Phone: {job.phone}</p>
            </div>
          </div>
            ...
            <div className="border-t border-gray-200 pt-4 mt-4">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">
                    {job.deliveredItems?.expected || job.items}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">
                    {job.podRecipientName || job.receiverName}
                  </p>
                </div>
                {job.signature && (
                  <div>
